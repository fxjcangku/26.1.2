...
public class TranslatableContents implements ComponentContents {
	...
	private static DataResult<Object> filterAllowedArguments(@Nullable final Object result) {
	...
	private static Object[] adjustArgs(final Optional<List<Object>> args) {
		return (Object[])args.map(a -> a.isEmpty() ? NO_ARGS : a.toArray()).orElse(NO_ARGS);
	}
