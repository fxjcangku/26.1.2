...
// ║ - 映射文件：build/obfuscation-mapping-v{版本}.txt                  ║
// ║   格式：obfuscation-mapping-v1.0.txt、obfuscation-mapping-v1.1.txt ║
// ║   每个版本独立映射文件，妥善保存到版本管理外的安全位置              ║
// ║   建议：复制到 Documents/26.1.2-mappings/ 按版本存档                ║
// ╠════════════════════════════════════════════════════════════════════╣
// ║                   GitHub README 发布规范                           ║
// ╠════════════════════════════════════════════════════════════════════╣
// ║ 必须元素（每次发版前检查）：                                       ║
// ║ 1. 动态徽章（Minecraft/Fabric/Meteor/Java 版本）                   ║
// ║ 2. 居中标题 + 快速链接（下载/文档/Discord/Issues）                 ║
// ║ 3. 核心特性分段：中文化、自动农场、指令手册                         ║
// ║ 4. 详细使用说明（准备/运行/推荐配置）                              ║
// ║ 5. 技术特性（纯客户端/标准交互包/状态机设计）                      ║
// ║ 6. 参考与致谢：Meteor 模板链接、Baritone 链接                      ║
// ║ 7. 更新日志（emoji + 版本号 + 日期）                               ║
// ║ 8. 底部居中：slogan + Made with ❤️                                 ║
// ║                                                                    ║
// ║ 徽章样式：for-the-badge（统一风格，显眼专业）                      ║
// ║ 链接格式：[文字](URL) 或 ![](徽章URL)                              ║
// ║ emoji 使用：✨🌐🚜📚⚙️🔗📝📄                                         ║
// ║                                                                    ║
// ║ 禁止内容：                                                         ║
// ║ - 不提"混淆"/"不开源"等负面词汇                                     ║
// ║ - 不暴露源码结构细节                                               ║
// ║ - 不提供 Personal jar 下载链接（仅 Official）                      ║
// ╚════════════════════════════════════════════════════════════════════╝
