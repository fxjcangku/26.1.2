...
import com.example.addon.mining.command.WKCommand;
...
import com.example.addon.enchant.ui.CustomEnchantSetting;
import com.example.addon.enchant.ui.EnchantmentSelectSetting;
import com.example.addon.enchant.command.FumoCommand;
import com.example.addon.enchant.gear.GearEnchantSetting;
import com.example.addon.hud.HudExample;
import com.example.addon.librarian.AutoLibrarianModule;
import com.example.addon.admdetector.AdminDetectorModule;
import com.example.addon.bonemeal.AutoBoneMeal;
...
import com.example.addon.villager.AutoVillagerTradeModule;
import com.example.addon.baritoneguide.BaritoneCommandGuideModule;
import com.example.addon.autodisconnect.CometDisconnectModule;
import com.example.addon.meteorguide.MeteorCommandGuideModule;
import com.example.addon.teleport.TeleportModule;
import com.example.addon.theme.ThemeModule;
import com.example.addon.userstats.UserStatsModule;
import com.example.addon.translations.YiyiaddonTranslationModule;
...
import com.example.addon.autochest.command.AutoChestCommand;
import com.example.addon.autochest.AutoChestModule;
import com.example.addon.autochest.config.ContainerTypeSetting;
...
public class AddonTemplate extends MeteorAddon {
    ...
    public void onInitialize() {
        ...
        // 自动图书管理员：自动寻路失业村民、放讲台刷交易、命中目标附魔自动购买
