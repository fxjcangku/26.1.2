...
public class SpawnPlacements {
	...
	private static <T extends Mob> void register(
		...
		SpawnPlacements.Data previous = (SpawnPlacements.Data)DATA_BY_TYPE.put(type, new SpawnPlacements.Data(heightmap, placementType, spawnPredicate));
		if (previous != null) {
	...
	public static SpawnPlacementType getPlacementType(final EntityType<?> type) {
		SpawnPlacements.Data data = (SpawnPlacements.Data)DATA_BY_TYPE.get(type);
