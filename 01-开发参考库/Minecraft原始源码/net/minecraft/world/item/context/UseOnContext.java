...
public class UseOnContext {
	...
	protected UseOnContext(final Level level, @Nullable final Player player, final InteractionHand hand, final ItemStack itemStack, final BlockHitResult hitResult) {
		this.player = player;
		this.hand = hand;
