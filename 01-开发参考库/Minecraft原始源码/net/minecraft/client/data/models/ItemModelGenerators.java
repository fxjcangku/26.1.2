...
public class ItemModelGenerators {
	...
	private void generateRecoveryCompassItem(final Item compass) {
		this.itemModelOutput
			.accept(compass, ItemModelUtils.rangeSelect(new CompassAngle(true, CompassAngleState.CompassTarget.RECOVERY), 32.0F, this.createCompassModels(compass)));
	}
		...
		this.itemModelOutput
			.accept(
				...
				ItemModelUtils.conditional(
					...
					ItemModelUtils.rangeSelect(new UseDuration(false), 0.05F, pulling0, ItemModelUtils.override(pulling1, 0.65F), ItemModelUtils.override(pulling2, 0.9F)),
					bowModel
				)
			);
	}
