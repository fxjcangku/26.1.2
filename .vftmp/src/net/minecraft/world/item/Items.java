...
public class Items {
   ...
   public static final Item ANCIENT_DEBRIS = registerBlock(Blocks.ANCIENT_DEBRIS, new Properties().fireResistant());
   ...
   public static final Item HEAVY_CORE = registerBlock(Blocks.HEAVY_CORE, new Properties().rarity(Rarity.EPIC));
   ...
   public static final Item NETHERITE_BLOCK = registerBlock(Blocks.NETHERITE_BLOCK, new Properties().fireResistant());
   ...
   public static final Item DECORATED_POT = registerBlock(
      ...
      new Properties().component(DataComponents.POT_DECORATIONS, PotDecorations.EMPTY).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   ...
   public static final Item DRAGON_EGG = registerBlock(Blocks.DRAGON_EGG, new Properties().rarity(Rarity.EPIC));
   ...
   public static final Item COMMAND_BLOCK = registerBlock(Blocks.COMMAND_BLOCK, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC));
   public static final Item BEACON = registerBlock(Blocks.BEACON, new Properties().rarity(Rarity.RARE));
   ...
   public static final Item BARRIER = registerBlock(Blocks.BARRIER, new Properties().rarity(Rarity.EPIC));
   ...
   public static final Item REPEATING_COMMAND_BLOCK = registerBlock(
      Blocks.REPEATING_COMMAND_BLOCK, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC)
   );
   public static final Item CHAIN_COMMAND_BLOCK = registerBlock(Blocks.CHAIN_COMMAND_BLOCK, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC));
   ...
   public static final Item STRUCTURE_VOID = registerBlock(Blocks.STRUCTURE_VOID, new Properties().rarity(Rarity.EPIC));
   public static final Item SHULKER_BOX = registerBlock(
      Blocks.SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item WHITE_SHULKER_BOX = registerBlock(
      Blocks.WHITE_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item ORANGE_SHULKER_BOX = registerBlock(
      Blocks.ORANGE_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item MAGENTA_SHULKER_BOX = registerBlock(
      Blocks.MAGENTA_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item LIGHT_BLUE_SHULKER_BOX = registerBlock(
      Blocks.LIGHT_BLUE_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item YELLOW_SHULKER_BOX = registerBlock(
      Blocks.YELLOW_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item LIME_SHULKER_BOX = registerBlock(
      Blocks.LIME_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item PINK_SHULKER_BOX = registerBlock(
      Blocks.PINK_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item GRAY_SHULKER_BOX = registerBlock(
      Blocks.GRAY_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item LIGHT_GRAY_SHULKER_BOX = registerBlock(
      Blocks.LIGHT_GRAY_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item CYAN_SHULKER_BOX = registerBlock(
      Blocks.CYAN_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item PURPLE_SHULKER_BOX = registerBlock(
      Blocks.PURPLE_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item BLUE_SHULKER_BOX = registerBlock(
      Blocks.BLUE_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item BROWN_SHULKER_BOX = registerBlock(
      Blocks.BROWN_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item GREEN_SHULKER_BOX = registerBlock(
      Blocks.GREEN_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item RED_SHULKER_BOX = registerBlock(
      Blocks.RED_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   public static final Item BLACK_SHULKER_BOX = registerBlock(
      Blocks.BLACK_SHULKER_BOX, new Properties().stacksTo(1).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
   );
   ...
   public static final Item CONDUIT = registerBlock(Blocks.CONDUIT, new Properties().rarity(Rarity.UNCOMMON));
   ...
   public static final Item REDSTONE = registerItem(
      "redstone", createBlockItemWithCustomItemName(Blocks.REDSTONE_WIRE), new Properties().trimMaterial(TrimMaterials.REDSTONE)
   );
   ...
   public static final Item SADDLE = registerItem("saddle", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.saddle()));
   public static final Item WHITE_HARNESS = registerItem(
      "white_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.WHITE))
   );
   public static final Item ORANGE_HARNESS = registerItem(
      "orange_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.ORANGE))
   );
   public static final Item MAGENTA_HARNESS = registerItem(
      "magenta_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.MAGENTA))
   );
   public static final Item LIGHT_BLUE_HARNESS = registerItem(
      "light_blue_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_BLUE))
   );
   public static final Item YELLOW_HARNESS = registerItem(
      "yellow_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.YELLOW))
   );
   public static final Item LIME_HARNESS = registerItem(
      "lime_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIME))
   );
   public static final Item PINK_HARNESS = registerItem(
      "pink_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PINK))
   );
   public static final Item GRAY_HARNESS = registerItem(
      "gray_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GRAY))
   );
   public static final Item LIGHT_GRAY_HARNESS = registerItem(
      "light_gray_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.LIGHT_GRAY))
   );
   public static final Item CYAN_HARNESS = registerItem(
      "cyan_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.CYAN))
   );
   public static final Item PURPLE_HARNESS = registerItem(
      "purple_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.PURPLE))
   );
   public static final Item BLUE_HARNESS = registerItem(
      "blue_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLUE))
   );
   public static final Item BROWN_HARNESS = registerItem(
      "brown_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BROWN))
   );
   public static final Item GREEN_HARNESS = registerItem(
      "green_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.GREEN))
   );
   public static final Item RED_HARNESS = registerItem(
      "red_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.RED))
   );
   public static final Item BLACK_HARNESS = registerItem(
      "black_harness", new Properties().stacksTo(1).component(DataComponents.EQUIPPABLE, Equippable.harness(DyeColor.BLACK))
   );
   public static final Item MINECART = registerItem("minecart", p -> new MinecartItem(EntityType.MINECART, p), new Properties().stacksTo(1));
   public static final Item CHEST_MINECART = registerItem("chest_minecart", p -> new MinecartItem(EntityType.CHEST_MINECART, p), new Properties().stacksTo(1));
   public static final Item FURNACE_MINECART = registerItem(
      "furnace_minecart", p -> new MinecartItem(EntityType.FURNACE_MINECART, p), new Properties().stacksTo(1)
   );
   public static final Item TNT_MINECART = registerItem("tnt_minecart", p -> new MinecartItem(EntityType.TNT_MINECART, p), new Properties().stacksTo(1));
   public static final Item HOPPER_MINECART = registerItem(
      "hopper_minecart", p -> new MinecartItem(EntityType.HOPPER_MINECART, p), new Properties().stacksTo(1)
   );
   public static final Item CARROT_ON_A_STICK = registerItem(
      "carrot_on_a_stick", p -> new FoodOnAStickItem<>(EntityType.PIG, 7, p), new Properties().durability(25)
   );
   public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem(
      "warped_fungus_on_a_stick", p -> new FoodOnAStickItem<>(EntityType.STRIDER, 1, p), new Properties().durability(100)
   );
   ...
   public static final Item OAK_BOAT = registerItem("oak_boat", p -> new BoatItem(EntityType.OAK_BOAT, p), new Properties().stacksTo(1));
   public static final Item OAK_CHEST_BOAT = registerItem("oak_chest_boat", p -> new BoatItem(EntityType.OAK_CHEST_BOAT, p), new Properties().stacksTo(1));
   public static final Item SPRUCE_BOAT = registerItem("spruce_boat", p -> new BoatItem(EntityType.SPRUCE_BOAT, p), new Properties().stacksTo(1));
   public static final Item SPRUCE_CHEST_BOAT = registerItem(
      "spruce_chest_boat", p -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item BIRCH_BOAT = registerItem("birch_boat", p -> new BoatItem(EntityType.BIRCH_BOAT, p), new Properties().stacksTo(1));
   public static final Item BIRCH_CHEST_BOAT = registerItem("birch_chest_boat", p -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, p), new Properties().stacksTo(1));
   public static final Item JUNGLE_BOAT = registerItem("jungle_boat", p -> new BoatItem(EntityType.JUNGLE_BOAT, p), new Properties().stacksTo(1));
   public static final Item JUNGLE_CHEST_BOAT = registerItem(
      "jungle_chest_boat", p -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item ACACIA_BOAT = registerItem("acacia_boat", p -> new BoatItem(EntityType.ACACIA_BOAT, p), new Properties().stacksTo(1));
   public static final Item ACACIA_CHEST_BOAT = registerItem(
      "acacia_chest_boat", p -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item CHERRY_BOAT = registerItem("cherry_boat", p -> new BoatItem(EntityType.CHERRY_BOAT, p), new Properties().stacksTo(1));
   public static final Item CHERRY_CHEST_BOAT = registerItem(
      "cherry_chest_boat", p -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", p -> new BoatItem(EntityType.DARK_OAK_BOAT, p), new Properties().stacksTo(1));
   public static final Item DARK_OAK_CHEST_BOAT = registerItem(
      "dark_oak_chest_boat", p -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item PALE_OAK_BOAT = registerItem("pale_oak_boat", p -> new BoatItem(EntityType.PALE_OAK_BOAT, p), new Properties().stacksTo(1));
   public static final Item PALE_OAK_CHEST_BOAT = registerItem(
      "pale_oak_chest_boat", p -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item MANGROVE_BOAT = registerItem("mangrove_boat", p -> new BoatItem(EntityType.MANGROVE_BOAT, p), new Properties().stacksTo(1));
   public static final Item MANGROVE_CHEST_BOAT = registerItem(
      "mangrove_chest_boat", p -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, p), new Properties().stacksTo(1)
   );
   public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", p -> new BoatItem(EntityType.BAMBOO_RAFT, p), new Properties().stacksTo(1));
   public static final Item BAMBOO_CHEST_RAFT = registerItem(
      "bamboo_chest_raft", p -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, p), new Properties().stacksTo(1)
   );
   public static final Item STRUCTURE_BLOCK = registerBlock(Blocks.STRUCTURE_BLOCK, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC));
   public static final Item JIGSAW = registerBlock(Blocks.JIGSAW, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC));
   public static final Item TEST_BLOCK = registerBlock(
      Blocks.TEST_BLOCK,
      GameMasterBlockItem::new,
      new Properties().rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(TestBlock.MODE, TestBlockMode.START))
   );
   public static final Item TEST_INSTANCE_BLOCK = registerBlock(Blocks.TEST_INSTANCE_BLOCK, GameMasterBlockItem::new, new Properties().rarity(Rarity.EPIC));
   public static final Item TURTLE_HELMET = registerItem("turtle_helmet", new Properties().humanoidArmor(ArmorMaterials.TURTLE_SCUTE, ArmorType.HELMET));
   ...
   public static final Item WOLF_ARMOR = registerItem("wolf_armor", new Properties().wolfArmor(ArmorMaterials.ARMADILLO_SCUTE));
   public static final Item FLINT_AND_STEEL = registerItem("flint_and_steel", FlintAndSteelItem::new, new Properties().durability(64));
   public static final Item BOWL = registerItem("bowl");
   public static final Item APPLE = registerItem("apple", new Properties().food(Foods.APPLE));
   public static final Item BOW = registerItem("bow", BowItem::new, new Properties().durability(384).enchantable(1));
   ...
   public static final Item DIAMOND = registerItem("diamond", new Properties().trimMaterial(TrimMaterials.DIAMOND));
   public static final Item EMERALD = registerItem("emerald", new Properties().trimMaterial(TrimMaterials.EMERALD));
   public static final Item LAPIS_LAZULI = registerItem("lapis_lazuli", new Properties().trimMaterial(TrimMaterials.LAPIS));
   public static final Item QUARTZ = registerItem("quartz", new Properties().trimMaterial(TrimMaterials.QUARTZ));
   public static final Item AMETHYST_SHARD = registerItem("amethyst_shard", new Properties().trimMaterial(TrimMaterials.AMETHYST));
   public static final Item RAW_IRON = registerItem("raw_iron");
   public static final Item IRON_INGOT = registerItem("iron_ingot", new Properties().trimMaterial(TrimMaterials.IRON));
   public static final Item RAW_COPPER = registerItem("raw_copper");
   public static final Item COPPER_INGOT = registerItem("copper_ingot", new Properties().trimMaterial(TrimMaterials.COPPER));
   public static final Item RAW_GOLD = registerItem("raw_gold");
   public static final Item GOLD_INGOT = registerItem("gold_ingot", new Properties().trimMaterial(TrimMaterials.GOLD));
   public static final Item NETHERITE_INGOT = registerItem("netherite_ingot", new Properties().fireResistant().trimMaterial(TrimMaterials.NETHERITE));
   public static final Item NETHERITE_SCRAP = registerItem("netherite_scrap", new Properties().fireResistant());
   public static final Item WOODEN_SWORD = registerItem("wooden_sword", new Properties().sword(ToolMaterial.WOOD, 3.0F, -2.4F));
   public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", p -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, p));
   public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", new Properties().pickaxe(ToolMaterial.WOOD, 1.0F, -2.8F));
   ...
   public static final Item COPPER_SWORD = registerItem("copper_sword", new Properties().sword(ToolMaterial.COPPER, 3.0F, -2.4F));
   public static final Item COPPER_SHOVEL = registerItem("copper_shovel", p -> new ShovelItem(ToolMaterial.COPPER, 1.5F, -3.0F, p));
   public static final Item COPPER_PICKAXE = registerItem("copper_pickaxe", new Properties().pickaxe(ToolMaterial.COPPER, 1.0F, -2.8F));
   ...
   public static final Item STONE_SWORD = registerItem("stone_sword", new Properties().sword(ToolMaterial.STONE, 3.0F, -2.4F));
   public static final Item STONE_SHOVEL = registerItem("stone_shovel", p -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, p));
   public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", new Properties().pickaxe(ToolMaterial.STONE, 1.0F, -2.8F));
   ...
   public static final Item GOLDEN_SWORD = registerItem("golden_sword", new Properties().sword(ToolMaterial.GOLD, 3.0F, -2.4F));
   public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", p -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, p));
   public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", new Properties().pickaxe(ToolMaterial.GOLD, 1.0F, -2.8F));
   ...
   public static final Item IRON_SWORD = registerItem("iron_sword", new Properties().sword(ToolMaterial.IRON, 3.0F, -2.4F));
   public static final Item IRON_SHOVEL = registerItem("iron_shovel", p -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, p));
   public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", new Properties().pickaxe(ToolMaterial.IRON, 1.0F, -2.8F));
   ...
   public static final Item DIAMOND_SWORD = registerItem("diamond_sword", new Properties().sword(ToolMaterial.DIAMOND, 3.0F, -2.4F));
   public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", p -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, p));
   public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", new Properties().pickaxe(ToolMaterial.DIAMOND, 1.0F, -2.8F));
   ...
   public static final Item NETHERITE_SWORD = registerItem("netherite_sword", new Properties().sword(ToolMaterial.NETHERITE, 3.0F, -2.4F).fireResistant());
   public static final Item NETHERITE_SHOVEL = registerItem(
      "netherite_shovel", p -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, p), new Properties().fireResistant()
   );
   public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", new Properties().pickaxe(ToolMaterial.NETHERITE, 1.0F, -2.8F).fireResistant());
   public static final Item NETHERITE_AXE = registerItem(
      "netherite_axe", p -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, p), new Properties().fireResistant()
   );
   public static final Item NETHERITE_HOE = registerItem(
      "netherite_hoe", p -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, p), new Properties().fireResistant()
   );
   public static final Item STICK = registerItem("stick");
   public static final Item MUSHROOM_STEW = registerItem("mushroom_stew", new Properties().stacksTo(1).food(Foods.MUSHROOM_STEW).usingConvertsTo(BOWL));
   ...
   public static final Item BREAD = registerItem("bread", new Properties().food(Foods.BREAD));
   public static final Item LEATHER_HELMET = registerItem("leather_helmet", new Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.HELMET));
   public static final Item LEATHER_CHESTPLATE = registerItem(
      "leather_chestplate", new Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE)
   );
   public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", new Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.LEGGINGS));
   public static final Item LEATHER_BOOTS = registerItem("leather_boots", new Properties().humanoidArmor(ArmorMaterials.LEATHER, ArmorType.BOOTS));
   public static final Item COPPER_HELMET = registerItem("copper_helmet", new Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.HELMET));
   public static final Item COPPER_CHESTPLATE = registerItem("copper_chestplate", new Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.CHESTPLATE));
   public static final Item COPPER_LEGGINGS = registerItem("copper_leggings", new Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.LEGGINGS));
   public static final Item COPPER_BOOTS = registerItem("copper_boots", new Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.BOOTS));
   public static final Item CHAINMAIL_HELMET = registerItem(
      "chainmail_helmet", new Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.HELMET).rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_CHESTPLATE = registerItem(
      "chainmail_chestplate", new Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE).rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_LEGGINGS = registerItem(
      "chainmail_leggings", new Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS).rarity(Rarity.UNCOMMON)
   );
   public static final Item CHAINMAIL_BOOTS = registerItem(
      "chainmail_boots", new Properties().humanoidArmor(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS).rarity(Rarity.UNCOMMON)
   );
   public static final Item IRON_HELMET = registerItem("iron_helmet", new Properties().humanoidArmor(ArmorMaterials.IRON, ArmorType.HELMET));
   public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", new Properties().humanoidArmor(ArmorMaterials.IRON, ArmorType.CHESTPLATE));
   public static final Item IRON_LEGGINGS = registerItem("iron_leggings", new Properties().humanoidArmor(ArmorMaterials.IRON, ArmorType.LEGGINGS));
   public static final Item IRON_BOOTS = registerItem("iron_boots", new Properties().humanoidArmor(ArmorMaterials.IRON, ArmorType.BOOTS));
   public static final Item DIAMOND_HELMET = registerItem("diamond_helmet", new Properties().humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.HELMET));
   public static final Item DIAMOND_CHESTPLATE = registerItem(
      "diamond_chestplate", new Properties().humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.CHESTPLATE)
   );
   public static final Item DIAMOND_LEGGINGS = registerItem("diamond_leggings", new Properties().humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.LEGGINGS));
   public static final Item DIAMOND_BOOTS = registerItem("diamond_boots", new Properties().humanoidArmor(ArmorMaterials.DIAMOND, ArmorType.BOOTS));
   public static final Item GOLDEN_HELMET = registerItem("golden_helmet", new Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.HELMET));
   public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", new Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.CHESTPLATE));
   public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", new Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.LEGGINGS));
   public static final Item GOLDEN_BOOTS = registerItem("golden_boots", new Properties().humanoidArmor(ArmorMaterials.GOLD, ArmorType.BOOTS));
   public static final Item NETHERITE_HELMET = registerItem(
      "netherite_helmet", new Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.HELMET).fireResistant()
   );
   public static final Item NETHERITE_CHESTPLATE = registerItem(
      "netherite_chestplate", new Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE).fireResistant()
   );
   public static final Item NETHERITE_LEGGINGS = registerItem(
      "netherite_leggings", new Properties().humanoidArmor(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS).fireResistant()
   );
   ...
   public static final Item PORKCHOP = registerItem("porkchop", new Properties().food(Foods.PORKCHOP));
   public static final Item COOKED_PORKCHOP = registerItem("cooked_porkchop", new Properties().food(Foods.COOKED_PORKCHOP));
   public static final Item PAINTING = registerItem("painting", p -> new HangingEntityItem(EntityType.PAINTING, p));
   public static final Item GOLDEN_APPLE = registerItem("golden_apple", new Properties().food(Foods.GOLDEN_APPLE, Consumables.GOLDEN_APPLE));
   ...
   public static final Item OAK_SIGN = registerBlock(Blocks.OAK_SIGN, (b, p) -> new SignItem(b, Blocks.OAK_WALL_SIGN, p), new Properties().stacksTo(16));
   public static final Item SPRUCE_SIGN = registerBlock(
      Blocks.SPRUCE_SIGN, (b, p) -> new SignItem(b, Blocks.SPRUCE_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item BIRCH_SIGN = registerBlock(Blocks.BIRCH_SIGN, (b, p) -> new SignItem(b, Blocks.BIRCH_WALL_SIGN, p), new Properties().stacksTo(16));
   public static final Item JUNGLE_SIGN = registerBlock(
      Blocks.JUNGLE_SIGN, (b, p) -> new SignItem(b, Blocks.JUNGLE_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item ACACIA_SIGN = registerBlock(
      Blocks.ACACIA_SIGN, (b, p) -> new SignItem(b, Blocks.ACACIA_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item CHERRY_SIGN = registerBlock(
      Blocks.CHERRY_SIGN, (b, p) -> new SignItem(b, Blocks.CHERRY_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item DARK_OAK_SIGN = registerBlock(
      Blocks.DARK_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.DARK_OAK_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item PALE_OAK_SIGN = registerBlock(
      Blocks.PALE_OAK_SIGN, (b, p) -> new SignItem(b, Blocks.PALE_OAK_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item MANGROVE_SIGN = registerBlock(
      Blocks.MANGROVE_SIGN, (b, p) -> new SignItem(b, Blocks.MANGROVE_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item BAMBOO_SIGN = registerBlock(
      Blocks.BAMBOO_SIGN, (b, p) -> new SignItem(b, Blocks.BAMBOO_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item CRIMSON_SIGN = registerBlock(
      Blocks.CRIMSON_SIGN, (b, p) -> new SignItem(b, Blocks.CRIMSON_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item WARPED_SIGN = registerBlock(
      Blocks.WARPED_SIGN, (b, p) -> new SignItem(b, Blocks.WARPED_WALL_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item OAK_HANGING_SIGN = registerBlock(
      Blocks.OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.OAK_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item SPRUCE_HANGING_SIGN = registerBlock(
      Blocks.SPRUCE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.SPRUCE_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item BIRCH_HANGING_SIGN = registerBlock(
      Blocks.BIRCH_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BIRCH_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item JUNGLE_HANGING_SIGN = registerBlock(
      Blocks.JUNGLE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.JUNGLE_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item ACACIA_HANGING_SIGN = registerBlock(
      Blocks.ACACIA_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.ACACIA_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item CHERRY_HANGING_SIGN = registerBlock(
      Blocks.CHERRY_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CHERRY_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item DARK_OAK_HANGING_SIGN = registerBlock(
      Blocks.DARK_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.DARK_OAK_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item PALE_OAK_HANGING_SIGN = registerBlock(
      Blocks.PALE_OAK_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.PALE_OAK_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item MANGROVE_HANGING_SIGN = registerBlock(
      Blocks.MANGROVE_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.MANGROVE_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item BAMBOO_HANGING_SIGN = registerBlock(
      Blocks.BAMBOO_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.BAMBOO_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item CRIMSON_HANGING_SIGN = registerBlock(
      Blocks.CRIMSON_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.CRIMSON_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item WARPED_HANGING_SIGN = registerBlock(
      Blocks.WARPED_HANGING_SIGN, (b, p) -> new HangingSignItem(b, Blocks.WARPED_WALL_HANGING_SIGN, p), new Properties().stacksTo(16)
   );
   public static final Item BUCKET = registerItem("bucket", p -> new BucketItem(Fluids.EMPTY, p), new Properties().stacksTo(16));
   public static final Item WATER_BUCKET = registerItem(
      "water_bucket", p -> new BucketItem(Fluids.WATER, p), new Properties().craftRemainder(BUCKET).stacksTo(1)
   );
   public static final Item LAVA_BUCKET = registerItem("lava_bucket", p -> new BucketItem(Fluids.LAVA, p), new Properties().craftRemainder(BUCKET).stacksTo(1));
   public static final Item POWDER_SNOW_BUCKET = registerItem(
      ...
      new Properties().stacksTo(1).useItemDescriptionPrefix()
   );
   public static final Item SNOWBALL = registerItem("snowball", SnowballItem::new, new Properties().stacksTo(16));
   public static final Item LEATHER = registerItem("leather");
   public static final Item MILK_BUCKET = registerItem(
      "milk_bucket", new Properties().craftRemainder(BUCKET).component(DataComponents.CONSUMABLE, Consumables.MILK_BUCKET).usingConvertsTo(BUCKET).stacksTo(1)
   );
   public static final Item PUFFERFISH_BUCKET = registerItem(
      ...
      new Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.PUFFERFISH)
   );
   public static final Item SALMON_BUCKET = registerItem(
      ...
      new Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.SALMON)
   );
   public static final Item COD_BUCKET = registerItem(
      ...
      new Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.COD)
   );
   public static final Item TROPICAL_FISH_BUCKET = registerItem(
      ...
      new Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY).component(DataComponents.FOOD, Foods.TROPICAL_FISH)
   );
   ...
   public static final Item BOOK = registerItem("book", new Properties().enchantable(1));
   public static final Item SLIME_BALL = registerItem("slime_ball");
   public static final Item EGG = registerItem(
      "egg", EggItem::new, new Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.TEMPERATE)
   );
   public static final Item BLUE_EGG = registerItem(
      "blue_egg", EggItem::new, new Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.COLD)
   );
   public static final Item BROWN_EGG = registerItem(
      "brown_egg", EggItem::new, new Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.WARM)
   );
   public static final Item COMPASS = registerItem("compass", CompassItem::new);
   public static final Item RECOVERY_COMPASS = registerItem("recovery_compass", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item BUNDLE = registerItem(
      "bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item WHITE_BUNDLE = registerItem(
      "white_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item ORANGE_BUNDLE = registerItem(
      "orange_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item MAGENTA_BUNDLE = registerItem(
      "magenta_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item LIGHT_BLUE_BUNDLE = registerItem(
      "light_blue_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item YELLOW_BUNDLE = registerItem(
      "yellow_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item LIME_BUNDLE = registerItem(
      "lime_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item PINK_BUNDLE = registerItem(
      "pink_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item GRAY_BUNDLE = registerItem(
      "gray_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item LIGHT_GRAY_BUNDLE = registerItem(
      "light_gray_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item CYAN_BUNDLE = registerItem(
      "cyan_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item PURPLE_BUNDLE = registerItem(
      "purple_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item BLUE_BUNDLE = registerItem(
      "blue_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item BROWN_BUNDLE = registerItem(
      "brown_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item GREEN_BUNDLE = registerItem(
      "green_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item RED_BUNDLE = registerItem(
      "red_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item BLACK_BUNDLE = registerItem(
      "black_bundle", BundleItem::new, new Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
   );
   public static final Item FISHING_ROD = registerItem("fishing_rod", FishingRodItem::new, new Properties().durability(64).enchantable(1));
   public static final Item CLOCK = registerItem("clock");
   public static final Item SPYGLASS = registerItem("spyglass", SpyglassItem::new, new Properties().stacksTo(1));
   public static final Item GLOWSTONE_DUST = registerItem("glowstone_dust");
   public static final Item COD = registerItem("cod", new Properties().food(Foods.COD));
   public static final Item SALMON = registerItem("salmon", new Properties().food(Foods.SALMON));
   public static final Item TROPICAL_FISH = registerItem("tropical_fish", new Properties().food(Foods.TROPICAL_FISH));
   public static final Item PUFFERFISH = registerItem("pufferfish", new Properties().food(Foods.PUFFERFISH, Consumables.PUFFERFISH));
   public static final Item COOKED_COD = registerItem("cooked_cod", new Properties().food(Foods.COOKED_COD));
   public static final Item COOKED_SALMON = registerItem("cooked_salmon", new Properties().food(Foods.COOKED_SALMON));
   ...
   public static final Item WHITE_DYE = registerItem("white_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.WHITE));
   public static final Item ORANGE_DYE = registerItem("orange_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.ORANGE));
   public static final Item MAGENTA_DYE = registerItem("magenta_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.MAGENTA));
   public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.LIGHT_BLUE));
   public static final Item YELLOW_DYE = registerItem("yellow_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.YELLOW));
   public static final Item LIME_DYE = registerItem("lime_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.LIME));
   public static final Item PINK_DYE = registerItem("pink_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.PINK));
   public static final Item GRAY_DYE = registerItem("gray_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.GRAY));
   public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.LIGHT_GRAY));
   public static final Item CYAN_DYE = registerItem("cyan_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.CYAN));
   public static final Item PURPLE_DYE = registerItem("purple_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.PURPLE));
   public static final Item BLUE_DYE = registerItem("blue_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.BLUE));
   public static final Item BROWN_DYE = registerItem("brown_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.BROWN));
   public static final Item GREEN_DYE = registerItem("green_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.GREEN));
   public static final Item RED_DYE = registerItem("red_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.RED));
   public static final Item BLACK_DYE = registerItem("black_dye", DyeItem::new, new Properties().component(DataComponents.DYE, DyeColor.BLACK));
   ...
   public static final Item CAKE = registerBlock(Blocks.CAKE, new Properties().stacksTo(1));
   public static final Item WHITE_BED = registerBlock(Blocks.WHITE_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item ORANGE_BED = registerBlock(Blocks.ORANGE_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item MAGENTA_BED = registerBlock(Blocks.MAGENTA_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item LIGHT_BLUE_BED = registerBlock(Blocks.LIGHT_BLUE_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item YELLOW_BED = registerBlock(Blocks.YELLOW_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item LIME_BED = registerBlock(Blocks.LIME_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item PINK_BED = registerBlock(Blocks.PINK_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item GRAY_BED = registerBlock(Blocks.GRAY_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item LIGHT_GRAY_BED = registerBlock(Blocks.LIGHT_GRAY_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item CYAN_BED = registerBlock(Blocks.CYAN_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item PURPLE_BED = registerBlock(Blocks.PURPLE_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item BLUE_BED = registerBlock(Blocks.BLUE_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item BROWN_BED = registerBlock(Blocks.BROWN_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item GREEN_BED = registerBlock(Blocks.GREEN_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item RED_BED = registerBlock(Blocks.RED_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item BLACK_BED = registerBlock(Blocks.BLACK_BED, BedItem::new, new Properties().stacksTo(1));
   public static final Item COOKIE = registerItem("cookie", new Properties().food(Foods.COOKIE));
   ...
   public static final Item FILLED_MAP = registerItem(
      "filled_map",
      MapItem::new,
      new Properties().component(DataComponents.MAP_COLOR, MapItemColor.DEFAULT).component(DataComponents.MAP_DECORATIONS, MapDecorations.EMPTY)
   );
   public static final Item SHEARS = registerItem(
      "shears", ShearsItem::new, new Properties().durability(238).component(DataComponents.TOOL, ShearsItem.createToolProperties())
   );
   public static final Item MELON_SLICE = registerItem("melon_slice", new Properties().food(Foods.MELON_SLICE));
   public static final Item DRIED_KELP = registerItem("dried_kelp", new Properties().food(Foods.DRIED_KELP, Consumables.DRIED_KELP));
   ...
   public static final Item BEEF = registerItem("beef", new Properties().food(Foods.BEEF));
   public static final Item COOKED_BEEF = registerItem("cooked_beef", new Properties().food(Foods.COOKED_BEEF));
   public static final Item CHICKEN = registerItem("chicken", new Properties().food(Foods.CHICKEN, Consumables.CHICKEN));
   public static final Item COOKED_CHICKEN = registerItem("cooked_chicken", new Properties().food(Foods.COOKED_CHICKEN));
   public static final Item ROTTEN_FLESH = registerItem("rotten_flesh", new Properties().food(Foods.ROTTEN_FLESH, Consumables.ROTTEN_FLESH));
   public static final Item ENDER_PEARL = registerItem("ender_pearl", EnderpearlItem::new, new Properties().stacksTo(16).useCooldown(1.0F));
   ...
   public static final Item SPIDER_EYE = registerItem("spider_eye", new Properties().food(Foods.SPIDER_EYE, Consumables.SPIDER_EYE));
   ...
   public static final Item EXPERIENCE_BOTTLE = registerItem(
      "experience_bottle", ExperienceBottleItem::new, new Properties().rarity(Rarity.UNCOMMON).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)
   );
   public static final Item FIRE_CHARGE = registerItem("fire_charge", FireChargeItem::new);
   public static final Item WIND_CHARGE = registerItem("wind_charge", WindChargeItem::new, new Properties().useCooldown(0.5F));
   public static final Item WRITABLE_BOOK = registerItem(
      "writable_book", WritableBookItem::new, new Properties().stacksTo(1).component(DataComponents.WRITABLE_BOOK_CONTENT, WritableBookContent.EMPTY)
   );
   public static final Item WRITTEN_BOOK = registerItem(
      "written_book", WrittenBookItem::new, new Properties().stacksTo(16).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)
   );
   ...
   public static final Item CARROT = registerItem("carrot", createBlockItemWithCustomItemName(Blocks.CARROTS), new Properties().food(Foods.CARROT));
   public static final Item POTATO = registerItem("potato", createBlockItemWithCustomItemName(Blocks.POTATOES), new Properties().food(Foods.POTATO));
   public static final Item BAKED_POTATO = registerItem("baked_potato", new Properties().food(Foods.BAKED_POTATO));
   public static final Item POISONOUS_POTATO = registerItem("poisonous_potato", new Properties().food(Foods.POISONOUS_POTATO, Consumables.POISONOUS_POTATO));
   public static final Item MAP = registerItem("map", EmptyMapItem::new);
   public static final Item GOLDEN_CARROT = registerItem("golden_carrot", new Properties().food(Foods.GOLDEN_CARROT));
   public static final Item SKELETON_SKULL = registerBlock(
      ...
      new Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
   );
   public static final Item WITHER_SKELETON_SKULL = registerBlock(
      ...
      new Properties().rarity(Rarity.RARE).equippableUnswappable(EquipmentSlot.HEAD)
   );
   ...
   public static final Item DRAGON_HEAD = registerBlock(
      ...
      new Properties().rarity(Rarity.EPIC).equippableUnswappable(EquipmentSlot.HEAD)
   );
   ...
   public static final Item PUMPKIN_PIE = registerItem("pumpkin_pie", new Properties().food(Foods.PUMPKIN_PIE));
   public static final Item FIREWORK_ROCKET = registerItem(
      "firework_rocket", FireworkRocketItem::new, new Properties().component(DataComponents.FIREWORKS, new Fireworks(1, List.of()))
   );
   ...
   public static final Item RESIN_BRICK = registerItem("resin_brick", new Properties().trimMaterial(TrimMaterials.RESIN));
   ...
   public static final Item RABBIT = registerItem("rabbit", new Properties().food(Foods.RABBIT));
   public static final Item COOKED_RABBIT = registerItem("cooked_rabbit", new Properties().food(Foods.COOKED_RABBIT));
   public static final Item RABBIT_STEW = registerItem("rabbit_stew", new Properties().stacksTo(1).food(Foods.RABBIT_STEW).usingConvertsTo(BOWL));
   ...
   public static final Item ARMOR_STAND = registerItem("armor_stand", ArmorStandItem::new, new Properties().stacksTo(16));
   public static final Item COPPER_HORSE_ARMOR = registerItem("copper_horse_armor", new Properties().horseArmor(ArmorMaterials.COPPER));
   public static final Item IRON_HORSE_ARMOR = registerItem("iron_horse_armor", new Properties().horseArmor(ArmorMaterials.IRON));
   public static final Item GOLDEN_HORSE_ARMOR = registerItem("golden_horse_armor", new Properties().horseArmor(ArmorMaterials.GOLD));
   public static final Item DIAMOND_HORSE_ARMOR = registerItem("diamond_horse_armor", new Properties().horseArmor(ArmorMaterials.DIAMOND));
   public static final Item NETHERITE_HORSE_ARMOR = registerItem("netherite_horse_armor", new Properties().horseArmor(ArmorMaterials.NETHERITE).fireResistant());
   public static final Item LEATHER_HORSE_ARMOR = registerItem("leather_horse_armor", new Properties().horseArmor(ArmorMaterials.LEATHER));
   ...
   public static final Item COMMAND_BLOCK_MINECART = registerItem(
      "command_block_minecart", p -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, p), new Properties().stacksTo(1).rarity(Rarity.EPIC)
   );
   public static final Item MUTTON = registerItem("mutton", new Properties().food(Foods.MUTTON));
   public static final Item COOKED_MUTTON = registerItem("cooked_mutton", new Properties().food(Foods.COOKED_MUTTON));
   public static final Item WHITE_BANNER = registerBlock(
      Blocks.WHITE_BANNER,
      (b, p) -> new BannerItem(b, Blocks.WHITE_WALL_BANNER, p),
      new Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
   );
   ...
   public static final Item END_CRYSTAL = registerItem(
      "end_crystal", EndCrystalItem::new, new Properties().component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)
   );
   public static final Item CHORUS_FRUIT = registerItem("chorus_fruit", new Properties().food(Foods.CHORUS_FRUIT, Consumables.CHORUS_FRUIT).useCooldown(1.0F));
   ...
   public static final Item BEETROOT = registerItem("beetroot", new Properties().food(Foods.BEETROOT));
   public static final Item BEETROOT_SEEDS = registerItem("beetroot_seeds", createBlockItemWithCustomItemName(Blocks.BEETROOTS));
   public static final Item BEETROOT_SOUP = registerItem("beetroot_soup", new Properties().stacksTo(1).food(Foods.BEETROOT_SOUP).usingConvertsTo(BOWL));
   public static final Item DRAGON_BREATH = registerItem("dragon_breath", new Properties().craftRemainder(GLASS_BOTTLE).rarity(Rarity.UNCOMMON));
   public static final Item SPLASH_POTION = registerItem(
      "splash_potion", SplashPotionItem::new, new Properties().stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY)
   );
   ...
   public static final Item TIPPED_ARROW = registerItem(
      "tipped_arrow",
      TippedArrowItem::new,
      new Properties().component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.125F)
   );
   public static final Item LINGERING_POTION = registerItem(
      "lingering_potion",
      LingeringPotionItem::new,
      new Properties().stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.POTION_DURATION_SCALE, 0.25F)
   );
      ...
      new Properties()
         ...
         .delayedComponent(
            ...
            context -> new BlocksAttacks(
               0.25F,
               1.0F,
               List.of(new DamageReduction(90.0F, Optional.empty(), 0.0F, 1.0F)),
               new ItemDamageFunction(3.0F, 1.0F, 1.0F),
   ...
   public static final Item WOODEN_SPEAR = registerItem(
      "wooden_spear", new Properties().spear(ToolMaterial.WOOD, 0.65F, 0.7F, 0.75F, 5.0F, 14.0F, 10.0F, 5.1F, 15.0F, 4.6F)
   );
   public static final Item STONE_SPEAR = registerItem(
      "stone_spear", new Properties().spear(ToolMaterial.STONE, 0.75F, 0.82F, 0.7F, 4.5F, 13.0F, 9.0F, 5.1F, 13.75F, 4.6F)
   );
   public static final Item COPPER_SPEAR = registerItem(
      "copper_spear", new Properties().spear(ToolMaterial.COPPER, 0.85F, 0.82F, 0.65F, 4.0F, 12.0F, 8.25F, 5.1F, 12.5F, 4.6F)
   );
   public static final Item IRON_SPEAR = registerItem(
      "iron_spear", new Properties().spear(ToolMaterial.IRON, 0.95F, 0.95F, 0.6F, 2.5F, 11.0F, 6.75F, 5.1F, 11.25F, 4.6F)
   );
   public static final Item GOLDEN_SPEAR = registerItem(
      "golden_spear", new Properties().spear(ToolMaterial.GOLD, 0.95F, 0.7F, 0.7F, 3.5F, 13.0F, 8.5F, 5.1F, 13.75F, 4.6F)
   );
   public static final Item DIAMOND_SPEAR = registerItem(
      "diamond_spear", new Properties().spear(ToolMaterial.DIAMOND, 1.05F, 1.075F, 0.5F, 3.0F, 10.0F, 6.5F, 5.1F, 10.0F, 4.6F)
   );
   public static final Item NETHERITE_SPEAR = registerItem(
      "netherite_spear", new Properties().spear(ToolMaterial.NETHERITE, 1.15F, 1.2F, 0.4F, 2.5F, 9.0F, 5.5F, 5.1F, 8.75F, 4.6F).fireResistant()
   );
   public static final Item TOTEM_OF_UNDYING = registerItem(
      "totem_of_undying", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).component(DataComponents.DEATH_PROTECTION, DeathProtection.TOTEM_OF_UNDYING)
   );
   ...
   public static final Item KNOWLEDGE_BOOK = registerItem(
      "knowledge_book", KnowledgeBookItem::new, new Properties().stacksTo(1).rarity(Rarity.EPIC).component(DataComponents.RECIPES, List.of())
   );
   ...
   public static final Item MUSIC_DISC_13 = registerItem(
      "music_disc_13", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.THIRTEEN)
   );
   public static final Item MUSIC_DISC_CAT = registerItem(
      "music_disc_cat", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CAT)
   );
   public static final Item MUSIC_DISC_BLOCKS = registerItem(
      "music_disc_blocks", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.BLOCKS)
   );
   public static final Item MUSIC_DISC_CHIRP = registerItem(
      "music_disc_chirp", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CHIRP)
   );
   public static final Item MUSIC_DISC_CREATOR = registerItem(
      "music_disc_creator", new Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.CREATOR)
   );
   public static final Item MUSIC_DISC_CREATOR_MUSIC_BOX = registerItem(
      "music_disc_creator_music_box", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.CREATOR_MUSIC_BOX)
   );
   public static final Item MUSIC_DISC_FAR = registerItem(
      "music_disc_far", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.FAR)
   );
   public static final Item MUSIC_DISC_LAVA_CHICKEN = registerItem(
      "music_disc_lava_chicken", new Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.LAVA_CHICKEN)
   );
   public static final Item MUSIC_DISC_MALL = registerItem(
      "music_disc_mall", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.MALL)
   );
   public static final Item MUSIC_DISC_MELLOHI = registerItem(
      "music_disc_mellohi", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.MELLOHI)
   );
   public static final Item MUSIC_DISC_STAL = registerItem(
      "music_disc_stal", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.STAL)
   );
   public static final Item MUSIC_DISC_STRAD = registerItem(
      "music_disc_strad", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.STRAD)
   );
   public static final Item MUSIC_DISC_WARD = registerItem(
      "music_disc_ward", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.WARD)
   );
   public static final Item MUSIC_DISC_11 = registerItem(
      "music_disc_11", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.ELEVEN)
   );
   public static final Item MUSIC_DISC_WAIT = registerItem(
      "music_disc_wait", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.WAIT)
   );
   public static final Item MUSIC_DISC_OTHERSIDE = registerItem(
      "music_disc_otherside", new Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.OTHERSIDE)
   );
   public static final Item MUSIC_DISC_RELIC = registerItem(
      "music_disc_relic", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.RELIC)
   );
   public static final Item MUSIC_DISC_5 = registerItem("music_disc_5", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.FIVE));
   public static final Item MUSIC_DISC_PIGSTEP = registerItem(
      "music_disc_pigstep", new Properties().stacksTo(1).rarity(Rarity.RARE).jukeboxPlayable(JukeboxSongs.PIGSTEP)
   );
   public static final Item MUSIC_DISC_PRECIPICE = registerItem(
      "music_disc_precipice", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.PRECIPICE)
   );
   public static final Item MUSIC_DISC_TEARS = registerItem(
      "music_disc_tears", new Properties().stacksTo(1).rarity(Rarity.UNCOMMON).jukeboxPlayable(JukeboxSongs.TEARS)
   );
   public static final Item DISC_FRAGMENT_5 = registerItem("disc_fragment_5", DiscFragmentItem::new, new Properties().rarity(Rarity.UNCOMMON));
   ...
   public static final Item NAUTILUS_SHELL = registerItem("nautilus_shell", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item IRON_NAUTILUS_ARMOR = registerItem("iron_nautilus_armor", new Properties().nautilusArmor(ArmorMaterials.IRON));
   public static final Item GOLDEN_NAUTILUS_ARMOR = registerItem("golden_nautilus_armor", new Properties().nautilusArmor(ArmorMaterials.GOLD));
   public static final Item DIAMOND_NAUTILUS_ARMOR = registerItem("diamond_nautilus_armor", new Properties().nautilusArmor(ArmorMaterials.DIAMOND));
   public static final Item NETHERITE_NAUTILUS_ARMOR = registerItem(
      "netherite_nautilus_armor", new Properties().nautilusArmor(ArmorMaterials.NETHERITE).fireResistant()
   );
   public static final Item COPPER_NAUTILUS_ARMOR = registerItem("copper_nautilus_armor", new Properties().nautilusArmor(ArmorMaterials.COPPER));
   public static final Item HEART_OF_THE_SEA = registerItem("heart_of_the_sea", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item CROSSBOW = registerItem(
      "crossbow",
      CrossbowItem::new,
      new Properties().stacksTo(1).durability(465).component(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY).enchantable(1)
   );
   ...
   public static final Item SWEET_BERRIES = registerItem(
      "sweet_berries", createBlockItemWithCustomItemName(Blocks.SWEET_BERRY_BUSH), new Properties().food(Foods.SWEET_BERRIES)
   );
   ...
   public static final Item HONEY_BOTTLE = registerItem(
      "honey_bottle",
      new Properties().craftRemainder(GLASS_BOTTLE).food(Foods.HONEY_BOTTLE, Consumables.HONEY_BOTTLE).usingConvertsTo(GLASS_BOTTLE).stacksTo(16)
   );
   ...
   public static final Item ECHO_SHARD = registerItem("echo_shard", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item BRUSH = registerItem("brush", BrushItem::new, new Properties().durability(64));
   public static final Item NETHERITE_UPGRADE_SMITHING_TEMPLATE = registerItem(
      "netherite_upgrade_smithing_template", SmithingTemplateItem::createNetheriteUpgradeTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "sentry_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item DUNE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "dune_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item COAST_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "coast_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item WILD_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "wild_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item WARD_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "ward_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.RARE)
   );
   public static final Item EYE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "eye_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.RARE)
   );
   public static final Item VEX_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "vex_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.RARE)
   );
   public static final Item TIDE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "tide_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "snout_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item RIB_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "rib_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "spire_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.RARE)
   );
   public static final Item WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "wayfinder_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "shaper_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "silence_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.EPIC)
   );
   public static final Item RAISER_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "raiser_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item HOST_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "host_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "flow_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = registerItem(
      "bolt_armor_trim_smithing_template", SmithingTemplateItem::createArmorTrimTemplate, new Properties().rarity(Rarity.UNCOMMON)
   );
   public static final Item ANGLER_POTTERY_SHERD = registerItem("angler_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item ARCHER_POTTERY_SHERD = registerItem("archer_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item ARMS_UP_POTTERY_SHERD = registerItem("arms_up_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item BLADE_POTTERY_SHERD = registerItem("blade_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item BREWER_POTTERY_SHERD = registerItem("brewer_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item BURN_POTTERY_SHERD = registerItem("burn_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item DANGER_POTTERY_SHERD = registerItem("danger_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item EXPLORER_POTTERY_SHERD = registerItem("explorer_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item FLOW_POTTERY_SHERD = registerItem("flow_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item FRIEND_POTTERY_SHERD = registerItem("friend_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item GUSTER_POTTERY_SHERD = registerItem("guster_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item HEART_POTTERY_SHERD = registerItem("heart_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item HEARTBREAK_POTTERY_SHERD = registerItem("heartbreak_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item HOWL_POTTERY_SHERD = registerItem("howl_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item MINER_POTTERY_SHERD = registerItem("miner_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item MOURNER_POTTERY_SHERD = registerItem("mourner_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item PLENTY_POTTERY_SHERD = registerItem("plenty_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item PRIZE_POTTERY_SHERD = registerItem("prize_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item SCRAPE_POTTERY_SHERD = registerItem("scrape_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item SHEAF_POTTERY_SHERD = registerItem("sheaf_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item SHELTER_POTTERY_SHERD = registerItem("shelter_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item SKULL_POTTERY_SHERD = registerItem("skull_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   public static final Item SNORT_POTTERY_SHERD = registerItem("snort_pottery_sherd", new Properties().rarity(Rarity.UNCOMMON));
   ...
   public static final Item COPPER_GOLEM_STATUE = registerBlock(
      ...
      new Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, Pose.STANDING))
   );
   ...
   private static Item registerSpawnEgg(final EntityType<?> type) {
      return registerItem(
         ResourceKey.create(Registries.ITEM, EntityType.getKey(type).withSuffix("_spawn_egg")), SpawnEggItem::new, new Properties().spawnEgg(type)
      );
   }
   ...
   private static Item registerBlock(final Block block, final Properties properties) {
      return registerBlock(block, BlockItem::new, properties);
   }

   private static Item registerBlock(final Block block, final UnaryOperator<Properties> propertiesFunction) {
   ...
   private static Item registerBlock(final Block block, final BiFunction<Block, Properties, Item> itemFactory) {
      return registerBlock(block, itemFactory, new Properties());
   }

   private static Item registerBlock(final Block block, final BiFunction<Block, Properties, Item> itemFactory, final Properties properties) {
      return registerItem(
   ...
   private static Item registerItem(final String name, final Function<Properties, Item> itemFactory) {
      return registerItem(vanillaItemId(name), itemFactory, new Properties());
   }

   private static Item registerItem(final String name, final Function<Properties, Item> itemFactory, final Properties properties) {
      return registerItem(vanillaItemId(name), itemFactory, properties);
   }

   private static Item registerItem(final String name, final Properties properties) {
   ...
   private static Item registerItem(final ResourceKey<Item> key, final Function<Properties, Item> itemFactory) {
      return registerItem(key, itemFactory, new Properties());
   }

   private static Item registerItem(final ResourceKey<Item> key, final Function<Properties, Item> itemFactory, final Properties properties) {
