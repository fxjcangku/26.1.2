...
import net.minecraft.advancements.criterion.DamageSourcePredicate.Builder;
...
public class Enchantments {
   ...
   public static void bootstrap(final BootstrapContext<Enchantment> context) {
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               EnchantmentEffectComponents.ATTRIBUTES,
               new EnchantmentAttributeEffect(
                  Identifier.withDefaultNamespace("enchantment.respiration"), Attributes.OXYGEN_BONUS, LevelBasedValue.perLevel(1.0F), Operation.ADD_VALUE
               )
            )
      );
      register(
      ...
      net.minecraft.advancements.criterion.EntityPredicate.Builder soulSpeedEffectCondition = net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
         .periodicTick(5)
         .flags(net.minecraft.advancements.criterion.EntityFlagsPredicate.Builder.flags().setIsFlying(false).setOnGround(true))
         .moving(MovementPredicate.horizontalSpeed(Doubles.atLeast(1.0E-5F)))
         .movementAffectedBy(
      ...
      net.minecraft.world.level.storage.loot.predicates.AllOfCondition.Builder soulSpeedMovementCondition = AllOfCondition.allOf(
         InvertedLootItemCondition.invert(
            LootItemEntityPropertyCondition.hasProperties(
               EntityTarget.THIS,
               net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
      ...
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(EntityTarget.THIS, soulSpeedEffectCondition)
            )
            .withEffect(
               EnchantmentEffectComponents.TICK,
               new PlaySoundEffect(List.of(SoundEvents.SOUL_ESCAPE), ConstantFloat.of(0.6F), UniformFloat.of(0.6F, 1.0F)),
               AllOfCondition.allOf(
                  LootItemRandomChanceCondition.randomChance(0.35F), LootItemEntityPropertyCondition.hasProperties(EntityTarget.THIS, soulSpeedEffectCondition)
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               EnchantmentEffectComponents.ATTRIBUTES,
               new EnchantmentAttributeEffect(
                  Identifier.withDefaultNamespace("enchantment.swift_sneak"), Attributes.SNEAKING_SPEED, LevelBasedValue.perLevel(0.15F), Operation.ADD_VALUE
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  EntityTarget.THIS,
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                     .entityType(EntityTypePredicate.of(entityTypes, EntityTypeTags.SENSITIVE_TO_SMITE))
               )
            )
      );
      register(
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  ...
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of(entityTypes, EntityTypeTags.ARROWS).build()
               )
            )
      );
      register(
                  ...
                  AnyOfCondition.anyOf(
                     InvertedLootItemCondition.invert(
                        LootItemEntityPropertyCondition.hasProperties(
                           EntityTarget.THIS,
                           net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                              .subPredicate(net.minecraft.advancements.criterion.PlayerPredicate.Builder.player().build())
                        )
                     ),
                     LootItemEntityPropertyCondition.hasProperties(
                        EntityTarget.THIS,
                        net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                           .subPredicate(
                              net.minecraft.advancements.criterion.PlayerPredicate.Builder.player()
                     ...
                     LootItemEntityPropertyCondition.hasProperties(
                        ...
                        net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                           .subPredicate(
                              net.minecraft.advancements.criterion.PlayerPredicate.Builder.player()
                                 .setFood(
                                    net.minecraft.advancements.criterion.FoodPredicate.Builder.food().withLevel(Ints.atLeast(Mth.floor(6.0F) + 1)).build()
                                 )
                                 .build()
                           )
                     )
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               AllOfCondition.allOf(
                  ...
                  LootItemEntityPropertyCondition.hasProperties(
                     EntityTarget.DIRECT_ATTACKER, net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of(entityTypes, EntityType.TRIDENT)
                  )
               )
            )
            .withEffect(
               ...
               AllOfCondition.allOf(
                  WeatherCheck.weather().setThundering(true),
                  LootItemEntityPropertyCondition.hasProperties(
                     EntityTarget.THIS, net.minecraft.advancements.criterion.EntityPredicate.Builder.entity().of(entityTypes, EntityType.TRIDENT)
                  ),
         ...
         Enchantment.enchantment(
            ...
            .withEffect(
               ...
               LootItemEntityPropertyCondition.hasProperties(
                  ...
                  net.minecraft.advancements.criterion.EntityPredicate.Builder.entity()
                     .flags(net.minecraft.advancements.criterion.EntityFlagsPredicate.Builder.flags().setIsFlying(false))
                     .moving(MovementPredicate.fallDistance(Doubles.atLeast(1.5)))
               )
            )
      );
      register(
