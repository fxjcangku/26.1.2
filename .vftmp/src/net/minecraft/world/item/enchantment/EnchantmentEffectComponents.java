...
public interface EnchantmentEffectComponents {
   ...
   DataComponentType<List<ChargingSounds>> CROSSBOW_CHARGING_SOUNDS = register("crossbow_charging_sounds", b -> b.persistent(ChargingSounds.CODEC.listOf()));
   ...
   private static <T> DataComponentType<T> register(final String id, final UnaryOperator<Builder<T>> builder) {
