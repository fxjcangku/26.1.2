...
import net.minecraft.world.inventory.GrindstoneMenu.1;
import net.minecraft.world.inventory.GrindstoneMenu.2;
import net.minecraft.world.inventory.GrindstoneMenu.3;
import net.minecraft.world.inventory.GrindstoneMenu.4;
...
public class GrindstoneMenu extends AbstractContainerMenu {
   ...
   private final Container repairSlots = new 1(this, 2);
   ...
   public GrindstoneMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
      ...
      this.access = access;
      this.addSlot(new 2(this, this.repairSlots, 0, 49, 19));
      this.addSlot(new 3(this, this.repairSlots, 1, 49, 40));
      this.addSlot(new 4(this, this.resultSlots, 2, 129, 34, access));
