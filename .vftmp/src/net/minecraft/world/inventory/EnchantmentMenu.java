...
import net.minecraft.world.inventory.EnchantmentMenu.1;
import net.minecraft.world.inventory.EnchantmentMenu.2;
import net.minecraft.world.inventory.EnchantmentMenu.3;
...
public class EnchantmentMenu extends AbstractContainerMenu {
   ...
   private final Container enchantSlots = new 1(this, 2);
   ...
   public EnchantmentMenu(final int containerId, final Inventory inventory, final ContainerLevelAccess access) {
      ...
      this.access = access;
      this.addSlot(new 2(this, this.enchantSlots, 0, 15, 47));
      this.addSlot(new 3(this, this.enchantSlots, 1, 35, 47));
   ...
   private List<EnchantmentInstance> getEnchantmentList(final RegistryAccess access, final ItemStack itemStack, final int slot, final int enchantmentCost) {
      ...
      Optional<Named<Enchantment>> tag = access.lookupOrThrow(Registries.ENCHANTMENT).get(EnchantmentTags.IN_ENCHANTING_TABLE);
      if (tag.isEmpty()) {
         return List.of();
      } else {
